          ...
          <Box sx={{ backgroundColor: 'background.paper', borderRadius: 1, p: 1 }} className="box-wrapper">
            ...
            <Typography paragraph>
              ...
              <strong className="initiator__strong">
                which requires that a new instance of the Chrome devtools be opened each time a modification is made to this Network Inspector tool
                (Ex. modifying the root URL, toggling the feature on/off, etc.)
              </strong>
            ...
            >
              {(showReqChain || initDataLoaded) && initReqChainResult && Object.keys(initReqChainResult).length > 0 ? (
                ...
                <p className="initiator__short-instructions">
                  ...
                  <br />
                  Follow the instructions above, then <strong className="initiator__strong">close</strong> and{' '}
                  <strong className="initiator__strong">re-open</strong> the Chrome Devtools.
                  <br />
                  ...
                  <RefreshIcon
                    ...
                    onClick={() => {
                      if (!initChainFeatureStatus || !rootUrl) {
                        handleRefreshClickToShowToastMessage(
                          `Make sure that the Network Inspector tool is enabled and that a root URL has been set.`
                        );
                        return;
                      }
