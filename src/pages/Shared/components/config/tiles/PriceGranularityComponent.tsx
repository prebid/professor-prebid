      ...
      <Card sx={{ width: 1, minHeight: tileHeight }}>
        ...
        <CardContent>
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12 }}>{expanded && <PriceGranularityTable priceGranularity={priceGranularity} customPriceBucket={customPriceBucket as any}></PriceGranularityTable>}</Grid>
          </Grid>
        </CardContent>
      </Card>
    </Grid>
