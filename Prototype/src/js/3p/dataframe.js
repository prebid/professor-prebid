window.dfjs = (function (exports) {
	...
	*/
	...
	var STRICT_METHOD$3 = arrayMethodIsStrict('reduceRight');
	...
	// `Array.prototype.reduceRight` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduceright
	_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$3 || !USES_TO_LENGTH$5 || CHROME_BUG$1 }, {
  ...
  window.regeneratorRuntime = null
	...
	var _marked = /*#__PURE__*/regeneratorRuntime.mark(makeGenerator),
	    _marked2 = /*#__PURE__*/regeneratorRuntime.mark(createIterGenerator);
	function isNumber(x) {
	...
	var FileNotFoundError = /*#__PURE__*/function (_Error) {
	...
	var MixedTypeError = /*#__PURE__*/function (_TypeError) {
	  _inherits(MixedTypeError, _TypeError);

	  var _super2 = _createSuper(MixedTypeError);
	  ...
	  function MixedTypeError() {
	    ...
	    _this2 = _super2.call(this, TypeError);
	...
	var NoSuchColumnError = /*#__PURE__*/function (_Error2) {
	  _inherits(NoSuchColumnError, _Error2);

	  var _super3 = _createSuper(NoSuchColumnError);
	...
	var WrongSchemaError = /*#__PURE__*/function (_Error3) {
	  _inherits(WrongSchemaError, _Error3);

	  var _super4 = _createSuper(WrongSchemaError);
	  ...
	  function WrongSchemaError(columns, expected) {
	    ...
	    _this4 = _super4.call(this, Error);
	...
	var ArgumentTypeError = /*#__PURE__*/function (_TypeError2) {
	  _inherits(ArgumentTypeError, _TypeError2);

	  var _super5 = _createSuper(ArgumentTypeError);
	  ...
	  function ArgumentTypeError(input, expected) {
	    ...
	    _this5 = _super5.call(this, TypeError);
	...
	var SQLParseError = /*#__PURE__*/function (_Error4) {
	  _inherits(SQLParseError, _Error4);

	  var _super6 = _createSuper(SQLParseError);
	  ...
	  function SQLParseError(message) {
	    ...
	    _this6 = _super6.call(this, Error);
	...
	var TableAlreadyExistsError = /*#__PURE__*/function (_Error5) {
	  _inherits(TableAlreadyExistsError, _Error5);

	  var _super7 = _createSuper(TableAlreadyExistsError);
	  ...
	  function TableAlreadyExistsError(tableName) {
	    ...
	    _this7 = _super7.call(this, Error);
	...
	var WrongTableNameError = /*#__PURE__*/function (_Error6) {
	  _inherits(WrongTableNameError, _Error6);

	  var _super8 = _createSuper(WrongTableNameError);
	  ...
	  function WrongTableNameError(tableName) {
	    ...
	    _this8 = _super8.call(this, Error);
	...
	var GroupedDataFrame = /*#__PURE__*/function () {
	  /**
	  ...
	  _createClass(GroupedDataFrame, [{
	    key: Symbol.iterator,
	    value: /*#__PURE__*/regeneratorRuntime.mark(function value() {
	      var _iterator, _step, hash;

	      return regeneratorRuntime.wrap(function value$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              _iterator = _createForOfIteratorHelper(this[__hashes__]);
	              _context.prev = 1;
	    ...
	    value: function aggregate(func) {
	      ...
	      return this.df.__newInstance__(_toConsumableArray(this).map(function (_ref9) {
	        ...
	        return _objectSpread2(_objectSpread2({}, groupKey), {}, _defineProperty({}, columnName, func(group, groupKey)));
	    ...
	    value: function melt() {
	      ...
	      return this.df.__newInstance__(this.aggregate(function (group) {
	        ...
	        return [].concat(_toConsumableArray(p), _toConsumableArray(aggregation.map(function (x) {
	          return _objectSpread2(_objectSpread2({}, rest), x);
	        })));
	      }, []), columns);
	    }
	  }]);
	...
	function groupBy(df, columnNames) {
	  ...
	  var _iterator2 = _createForOfIteratorHelper(df.toCollection(true)),
	      _step2;
	...
	var DataFrame = /*#__PURE__*/function () {
	  ...
	  _createClass(DataFrame, [{
	    ...
	    value: /*#__PURE__*/regeneratorRuntime.mark(function value() {
	      ...
	      return regeneratorRuntime.wrap(function value$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              _iterator = _createForOfIteratorHelper(this[__rows__]);
	              _context.prev = 1;
	    ...
	    key: "_join",
	    value: function _join(dfToJoin, columnNames, types, shouldDropDuplicates) {
	      ...
	      var res = [this.__newInstance__([], newColumns)].concat(_toConsumableArray(iter([].concat(_toConsumableArray(types[0] ? this._joinByType(gdf, gdfToJoin, types[0], newColumns) : []), _toConsumableArray(types[1] ? this._joinByType(gdfToJoin, gdf, types[1], newColumns) : [])), function (group) {
	    ...
	    value: function rename(param1, param2) {
	      if (arguments.length == 1) {
	        ...
	        var columnName = param1;
	        var replacement = param2;
	    ...
	    value: function filterWithIndex(condition) {
	      var func = _typeof(condition) === "object" ? function (row) {
	        return Object.entries(condition).map(function (_ref8) {
	    ...
	    */
	    ...
	    value: function findWithIndex(condition) {
	      var rs = this.filterWithIndex(condition);
	    ...
	    value: function sortBy(columnNames) {
	      ...
	      var sortedRows = this[__rows__].sort(function (p, n) {
	        return _columnNames.map(function (col) {
	          var _ref10 = [p.get(col), n.get(col)],
	              pValue = _ref10[0],
	              nValue = _ref10[1];
	      ...
	      if (_columnNames.length > 1) {
	        ...
	        sortedRows.forEach(function (row) {
	          var _iterator3 = _createForOfIteratorHelper(_columnNames),
	              _step3;
	    ...
	    value: function join(dfToJoin, columnNames) {
	      ...
	      var joinMethods = {
	        ...
	        full: function full() {
	          return _this6.fullJoin(dfToJoin, columnNames, shouldDropDuplicates);
	        },
	        outer: function outer() {
	          return _this6.outerJoin(dfToJoin, columnNames, shouldDropDuplicates);
	        },
	        left: function left() {
	          return _this6.leftJoin(dfToJoin, columnNames, shouldDropDuplicates);
	        },
	        right: function right() {
	          return _this6.rightJoin(dfToJoin, columnNames, shouldDropDuplicates);
	        }
	      };
	...
	function parseSelections(selections) {
	  ...
	  selections.shift();
	  return match$1(selections.join(" ").split(",").map(function (selection) {
